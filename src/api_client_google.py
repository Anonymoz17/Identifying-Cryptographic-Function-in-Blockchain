...
from api_client_supabase import _sb  # uses your .env-loaded client
...
def login_with_google(
    ...
    try:
        ...
        if not auth_url:
            return False, "No OAuth URL returned by Supabase (Google)", None
    ...
    try:
        ...
        if not session:
            return False, "No session returned from Google code exchange.", None
        ...
        return False, f"Code exchange failed (Google): {e}", None
