...
class TestCoreModels(unittest.TestCase):
    def test_algorithm_immutable_and_fields(self):
        ...
        self.assertTrue(a.__class__.__dataclass_params__.frozen)

    def test_scorecard_metrics_and_rationale(self):
        sc = ScoreCard(
            metrics={"security": 50, "performance": 60, "risk": 10},
        ...
        self.assertTrue(sc.__class__.__dataclass_params__.frozen)
