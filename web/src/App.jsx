      ...
      <Container className="grid items-center gap-10 py-20 lg:grid-cols-2">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="space-y-6">
          ...
          <div className="flex flex-wrap gap-3 pt-2">
            <Button as="a" href="https://github.com/Anonymoz17/Identifying-Cryptographic-Function-in-Blockchain/archive/refs/tags/1.1.1.zip" className="bg-gradient-to-r from-emerald-400 to-cyan-500 text-black">
