    ...
    <section className="relative overflow-hidden">
      ...
      <Container className="grid items-center gap-10 py-20 lg:grid-cols-2">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="space-y-6">
          <Badge><ShieldCheck className="h-4 w-4" /> Auditor-first crypto analysis</Badge>
          ...
          <p className="text-white/70 text-base sm:text-lg max-w-xl">
            CryptoScope maps cryptographic usage across codebases and binaries, flags weak/legacy algorithms,
            and provides NIST-informed scoring so you can justify findings with evidence.
          </p>
          <div className="flex flex-wrap gap-3 pt-2">
            <Button as="a" href="https://github.com/Anonymoz17/Identifying-Cryptographic-Function-in-Blockchain/archive/refs/tags/1.1.0.zip" className="bg-gradient-to-r from-emerald-400 to-cyan-500 text-black">
...
const features = [
  ...
  { icon: <Layers className="h-5 w-5" />, title: "Fits audit workflows", desc: "CLI/CI integration, role-appropriate outputs, and reproducible pipelines." },
];
